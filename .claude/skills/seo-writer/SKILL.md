---
name: seo-writer
description: Creates highly optimized, long-form SEO content for local search results. Use this skill when creating location pages, service pages, or any content that needs to rank well in local search. Incorporates semantic SEO principles, structured data markup, and comprehensive content requirements.
---
...
1. **Identify the Target Keyword**: Extract or confirm the product/service name and the target location
...
- Introduces the product/service within the first 100 words
...
### Example LSI Word Cloud for "Business Loans":

```
Primary: business loans
LSI Terms: SME funding, commercial finance, working capital,
business credit, invoice financing, asset finance, merchant cash advance,
cash flow solutions, business growth funding, startup loans,
enterprise lending, corporate finance, trade finance, equipment leasing,
bridging loans, overdraft facilities, credit lines
```
...
1. **Product/Service Name**: The exact product or service to write about
2. **Business Name**: Company or brand name (e.g., "Capiflo")
